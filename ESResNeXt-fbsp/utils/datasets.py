...
class DCASE(td.Dataset):
    ...
    def __init__(self,
        ...
        meta = self.load_meta("/home/noahdrisort/Desktop/DCASE/SoundEventClassification/Dataset/meta.csv")
        ...
        self.data = dict()
        self.load_data(meta, "/home/noahdrisort/Desktop/DCASE/SoundEventClassification/Dataset/train_labels")
